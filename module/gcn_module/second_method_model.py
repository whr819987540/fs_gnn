...
from module.graphsage_layer import GraphSageConvolution, GraphConvolution

# 第二种全程online的方式，这种方式下是一定要加FS层的，在训练模型之前做节点采样
class Graphsage_second(nn.Module):
...
class GCN_second(nn.Module):
    ...
    def forward(self, X:torch.Tensor, adjs:torch.Tensor, sampled_nodes:list):
        '''
